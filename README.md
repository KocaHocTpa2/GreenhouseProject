...
Расширенная версия проекта обеспечивает (без мороки с правилами), следующий расширенный функционал:
...
<li>Отображение атмосферного давления.
 ...
 Для запроса расширенной версии перейдите в папку "Запрос расширенной версии" и следуйте инструкциям в файле "Инструкции.txt"
